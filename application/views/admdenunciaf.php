            ...
            <div id="conteudo">
                    ...
                    <div class="header container">
                        ...
                        <div class="container shadow rounded responsive cont">
                            ...
                            <h5 class="mt-3 display-5">Idade:  <?php echo $conteudo->idade;?></h5>
                            <h5 class="mt-3 display-5">Manifestação: <?php echo $conteudo->forma;?></h5>
                            <h5 class="mt-3 display-5">Dia do caso: <?php echo date('d/m/y',strtotime($conteudo->dia));?></h5>
                            <h5 class="mt-3 display-5">Preconceito: <?php echo $conteudo->preconceito;?></h5>
                            <h5 class="mt-4 display-5">Descrição:<p><h5 class="display-5"><?php echo nl2br($conteudo->descricao);?></h5></p></h5>
                        </div>
        </div>
    </div>
<script>
