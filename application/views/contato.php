    ...
    <div class="wrapper-perfil">
            ...
            <div id="conteudo">
                   ...
                   <div class="container-fluid text-center margin">
                    <form action="<?php echo base_url('Adm/pcontato') ?>" method="POST">
                      ...
                      <div class="input-group mt-3">
                        ...
                        <select class="ml-3" id="filtro" name="filtro">
                          ...
                          <option value="assunto">Titulo</option>
                          <option value="email_r">Email do Remetente</option>
                    ...
                    <div class="table-responsive table-test mt-5">
                        <table class="table table-striped table-dark">
                          ...
                          <?php if($denuncias == false){
                                ...
                                <td>'.$denuncia->Nome.'</td>
                                <td>'.$denuncia->email_r.'</td>
                                <td>'.date('d/m/Y',strtotime($denuncia->dia)).'</td>
                                <td><a href="'.base_url('Adm/contatoreport/'.$denuncia->id).'"><div class="btn btn-primary"><i class="fas fa-eye"></i></div></a></td>
                                <td><button type="button" value="'.base_url('Adm/excluircont/'.$denuncia->id).'" onclick="question(this.value)" id="button" class="btn btn-danger">X</button></td>
                              </tr>';}}
                              ?>
                        ...
                        <?php if($denuncias !== false){  
                          echo $pagination;} ?>
                           <?php if(isset($retornar)){
                             echo '<a href="'.base_url('Adm/contato').'">'.$retornar.'</a>';
                        }?>
                      </div>
                    </div>
              </div>
