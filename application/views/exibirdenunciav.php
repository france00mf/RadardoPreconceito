...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/denunciav.css')?>"/>
    ...
    <div class="container b1">
        <div class="b1">
            ...
            <div class="row">
                <div class="col-lg-1"></div>
                <div class="col-lg-9">
                    <p><strong>Site:</strong> <?php echo $conteudo->lugar ?></p>
                    <br>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-5 col-sm-5">
                    <br><br>
                    <p>
                        <img src="<?php echo base_url($conteudo->fotocaminho)?>" class="imgDen justify-content-center">
                    </p>
                    <br>
                </div>
            </div>
