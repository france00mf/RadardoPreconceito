            ...
            <div id="conteudo">
                    ...
                    <div class="header container">
                        ...
                        <div class="container shadow rounded responsive cont">
                            <h5 class="display-5">Email do Report: <?php echo $conteudo->emailreport;?></h5>
                            <h5 class="mt-3 display-5">Data do envio: <?php echo date('d/m/y',strtotime($conteudo->envio));?></h5>
                            <h5 class="mt-3 display-5">Link do usuario reportado: <?php echo base_url('Profissionais/perfil/'.$conteudo->UserId)?></h5>
